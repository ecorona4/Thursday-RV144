...
We now want to run a statistical test to see if the aids vaccine was semingly effective. We state the null ans alternative hypothesis is for this test. 

$H_0:$ There is no relationship with getting aids and having taken the Aids Vaccine.
