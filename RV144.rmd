...
We would expect to see both graphs of eq size (50% on each side) if the two are independent. They do not appear to be equal  ... shedding doubt on thwe idea of independence. 
...
```
  ...
  We now test the independence of aids vacine aqnd placebo groups.   
$H_0:$ The placebo and aids vacine treatments is independent of contracting the disease aids.  
$h_a:$ Having tyhe vaccine is related to contracting the disease.   

The p-value of 0.4 means the probability of getting a result like that just obtained if the null hypotheis is true is appoximatelt 4 percent. This normally considered significant. 
